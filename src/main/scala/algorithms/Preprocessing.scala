...
object Preprocessing {
  val trainSample = 1.0
  val testSample = 1.0
  val train = "src/main/resources/train.csv"
  val test = "src/main/resources/test.csv"
  ...
  // StringIndexer for categorical columns (OneHotEncoder should be evaluated as well) (check OneHotEncoder from spark)
